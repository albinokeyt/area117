...
export const COLABORADORA_STATIONS: StationSeed[] = [
  ...
  { name: 'SANCTI-SPIRITUS', type: 'COLABORADORA', isFixedColaboradora: false, order: 42 },
...
export const STATION_EXCEL_COSTS: Record<string, StationExcelData> = {
  ...
  'SANCTI-SPIRITUS': { type: 'COLABORADORA', clhName: 'SALAMANCA', porte: 0.0060, pase: 0.0150, fin: 0.0100, defaultPrev: 1.1850, defaultCurr: 1.1850 },
...
// Precios Oficiales de P. Venta Sugerido de Gasóleo A (GOA) extraídos de la Columna G de CALCULO INICIAL
export const OFFICIAL_SUGGESTED_SALE_PRICES: Record<string, number> = {
  'TORREJON': 1.3200,
  'ARCOS JALON': 1.3200,
  'ALFAJARIN': 1.3200,
  'TORREMOCHA': 1.3350,
  ...
  'UCLES': 1.3200,
  'BENAMEJI': 1.3240,
  'SORIA ALCUBILLAS': 1.3350,
  'ES RIBA-ROJA': 1.3050,
  'RIBA-ROJA': 1.3050,
  'ES PISTA DE SILLA': 1.3050,
  'PISTA DE SILLA': 1.3050,
  'ES REAL DE GANDIA': 1.3050,
  'REAL DE GANDIA': 1.3050,
  'ES CHIVA': 1.3100,
  'CHIVA': 1.3100,
  'ES ALBERIC': 1.3150,
  'ALBERIC': 1.3150,
  'CATARROJA': 1.3000,
  'MANISES - EXOIL': 1.3300,
  'MANISES': 1.3300,
  'ABRERA': 1.3200,
  'VALDEHERRERA': 1.3300,
  'EL CASAR': 1.3300,
  'LA JOYOSA': 1.3400,
  'JUNDIZ NORPETROL': 1.3100,
  'OLIVERAL': 1.4200,
  'GUARROMAN': 1.3460,
  'VALDEPEÑAS': 1.3200,
  'OPEN': 1.3940,
  'TJOIL SEVILLA': 1.3000,
  'BENAVENTE': 1.3580,
  'IRUN ZAISA III': 1.3340,
  'TARRAGONA': 1.3580,
  'LACHAR': 1.3500,
  'LA CAMPANA': 1.3200,
  'AVILESINA': 1.3570,
  ...
  'DARRO - A92': 1.3210,
  'MERIDA': 1.4136,
  'SANCTI-SPIRITUS': 1.3400,
  'MURCIA': 1.3720,
  'NORIOIL': 1.2920,
  'SAN VICENTE DEL PALACIO': 1.3560,
  'WATERY ARANDA': 1.3530,
  'BERA': 1.2950,
  'PUERTO DE BARCELONA': 1.3250,
  'GIRONA-CALSINA': 1.3350,
  'FEGOBLAN PONTEVEDRA': 1.3590,
  'VEGA DE VALCARCE': 1.3510,
  'HOILA TOLEDO': 1.3670,
  'PETREM FIGUERES': 1.3280,
  'PETREM TRUCKS FIGUERES': 1.3280,
};
